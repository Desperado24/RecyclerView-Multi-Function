...
public class XRecyclerView extends RecyclerView {
    ...
    public void onScrollStateChanged(int state) {
        ...
        if (state == RecyclerView.SCROLL_STATE_IDLE && mLoadingListener != null && !isLoadingData && loadingMoreEnabled) {
            ...
            Log.i("XRecyclerView","getChildCount:"+layoutManager.getChildCount());
            Log.i("XRecyclerView","getItemCount:"+layoutManager.getItemCount());
            Log.i("XRecyclerView","isNoMore:"+isNoMore);
            Log.i("XRecyclerView","mRefreshHeader:"+(mRefreshHeader.getState() < ArrowRefreshHeader.STATE_REFRESHING));
            Log.i("XRecyclerView","lastVisibleItemPosition:"+lastVisibleItemPosition);
            Log.i("XRecyclerView","mPageCount:"+mPageCount);
            if (layoutManager.getChildCount() > 0
                    && lastVisibleItemPosition >= mPageCount + 1  && !isNoMore && mRefreshHeader.getState() < ArrowRefreshHeader.STATE_REFRESHING) {
                isLoadingData = true;
                if (mFootView instanceof LoadingMoreFooter) {
            ...
            }else if(canLoadPre && lastVisibleItemPosition < 1){
                mLoadingListener.onRefresh();
            }
        }
    }
